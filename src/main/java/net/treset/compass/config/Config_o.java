...
public class Config_o implements IConfigHandler {
    ...
    public static void loadFromFile() {
        ...
        if (configFile.exists() && configFile.isFile() && configFile.canRead()) { //does file exist and is readable
            ...
            if ((obj = FileTools.readJsonFile(configFile)) != null) { //read file
                ConfigUtils.readConfigBase(obj, "General", Config_o.General.OPTIONS); //read category general options
                ConfigUtils.readConfigBase(obj, "Waypoints", Config_o.Waypoints.ALL_OPTIONS); //read category waypoint options
            }
        }
    }
    ...
    public static void saveToFile() {
        ...
        if ((dir.exists() && dir.isDirectory()) || dir.mkdirs()) { //does config dir exist or create it
            ...
            ConfigUtils.writeConfigBase(obj, "General", Config_o.General.OPTIONS); //add category general options
            ConfigUtils.writeConfigBase(obj, "Waypoints", Config_o.Waypoints.ALL_OPTIONS); //add category waypoint options
